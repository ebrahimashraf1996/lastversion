                                        ...
                                        <form class="form"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="text-center col-md-6">
                                                    @if(str_ends_with($service->photo, '.jpg') || str_ends_with($service->photo, '.png') || str_ends_with($service->photo, '.jpeg'))<img style="width: 300px; height: 300px;" src="{{$service -> photo}}">@else لا يوجد @endif
                                                </div>
                                                <br><br><br>
                                                <br><br><br>
                                                <br><br><br>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" id="name"
                                                                      ...
                                                                      name="content">{{$service->content}}</textarea>
                                                            @error("content")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
